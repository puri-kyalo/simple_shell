 ...
 * Return: 0 if no numbers in string, else -1 on error
 */
int _erratoi(char *s)
{
	int i = 0;
...
/**
 * remove_comments - write a function replaces first instance
 * of '#' with '\0'
 * @buf: is the add of the string to modify.
 * Return: 0 Always
 */

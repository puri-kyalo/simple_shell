 ...
 * @num: the node index used by his
 ...
 * @head: the addr of pointer to head node.
 * @str: the string field of node.
...
/**
 * print_list_str - a function that prints only the string
 ...
 * @head: the addr of ptr to first node.
 ...
 * @head_ptr: the addr of pointer to head node.
 * Return: void.
 */

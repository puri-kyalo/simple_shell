...
/**
 * get_history_file - function that gets the hist file.
...
/**
 * read_history - function that reads hist from file
 * @info: the param structure.
 ...
 * @info: is the structure containing potential args
 * @buf: buffer.
...
/**
 * renumber_history - function that renumbers the hist
 * linked list after changes.
 * @info: the struct containing potential args.
